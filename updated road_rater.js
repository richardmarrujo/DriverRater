...
const connectionString = "Driver={ODBC Driver 17 for SQL Server};Server=localhost;Database=RoadRater;Trusted_Connection=Yes;";
        ...
        sql.query(connectionString, insertQuery, [username, hashedPassword], (err) => {
            if (err) {
               ...
               // Send email notification
                ...
                const emailText = `A new user with the username ${username} has been registered.`;
                sendEmail('richardmarrujo1990@gmail.com', emailSubject, emailText);
